...
import { createReviewSchema, updateReviewSchema, reviewIdSchema } from "../validations/reviewValidations";
...
export const validateReviewId = validateRequest(reviewIdSchema);
